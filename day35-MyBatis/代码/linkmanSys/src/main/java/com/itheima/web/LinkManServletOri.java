...
public class LinkManServletOri extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
         ...
         */
        try {
            Class<LinkManServletOri> c = LinkManServletOri.class;
            LinkManServletOri instance = c.newInstance();
    ...
    private void findPage(HttpServletRequest request, HttpServletResponse response) throws IOException {
        try {
            ...
            pageBean.setCurPageNo(pageInfo.getPageNum());       //封装当前页码
            pageBean.setPageSize(pageInfo.getPageSize());       //封装每页显示条数
            pageBean.setList(pageInfo.getList());               //封装每页显示数据
            pageBean.setCount((int)pageInfo.getTotal());        //封装总条数
            pageBean.setTotalPage(pageInfo.getPages());         //封装总页数
